...
#ifndef ReverbJUCEFXParams_H
#define ReverbJUCEFXParams_H
...
struct ReverbJUCERTPCParams
{
    AkReal32 fPlaceholder;
};

struct ReverbJUCENonRTPCParams
{
};

struct ReverbJUCEFXParams
    : public AK::IAkPluginParam
{
    ReverbJUCEFXParams();
    ReverbJUCEFXParams(const ReverbJUCEFXParams& in_rParams);
    ...
    ReverbJUCERTPCParams RTPC;
    ReverbJUCENonRTPCParams NonRTPC;
};

#endif // ReverbJUCEFXParams_H
