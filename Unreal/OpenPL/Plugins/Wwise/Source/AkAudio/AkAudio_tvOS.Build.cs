...
public class AkUEPlatform_TVOS : AkUEPlatform
{
	public AkUEPlatform_TVOS(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
	...
	public override string AkPlatformLibDir { get { return "tvOS"; } }
	...
	{
		var libs = GetAllLibrariesInFolder(Path.Combine(ThirdPartyFolder, AkPlatformLibDir, AkConfigurationDir + "-appletvos", "lib"), "a", true);
